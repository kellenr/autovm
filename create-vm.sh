...
echo "  Mode: NAT"
echo "  Host Gateway: 10.0.2.2"
echo "  Port Forwarding:"
echo "    SSH: localhost:2222 → VM:22"
echo ""
echo "Preseed Configuration:"
echo "  Server: http://10.0.2.2:8000"
echo "  File: preseed.cfg"
echo ""
echo "Next steps:"
echo "  1. Start preseed server:"
echo "     bash start-preseed-server.sh"
echo ""
echo "  2. Start VM:"
echo "     bash start-vm.sh"
echo ""
echo "  3. During Debian installation:"
echo "     • Select 'Automated install'"
echo "     • Enter preseed URL: http://10.0.2.2:8000/preseed.cfg"
echo ""
echo "  4. Test connectivity (if needed):"
echo "     bash test-connectivity.sh"
echo "===================================================================="
